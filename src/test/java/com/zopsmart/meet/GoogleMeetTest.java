...
public class GoogleMeetTest {
    ...
    public void login() throws InterruptedException {
        WebElement signInButton = wait.until(ExpectedConditions
                .elementToBeClickable(By.xpath("//a[contains(text(),'Sign in')]")));
        signInButton.click();
        driver.findElement(By.cssSelector("input[type='email']")).sendKeys("test-hiring@raramuri.tech");
        driver.findElement(By.xpath("//span[text()='Next']")).click();
        WebElement passwordText = wait.until(ExpectedConditions.elementToBeClickable(By.name("password")));
        passwordText.sendKeys("Zopsmart@2022");
        WebElement next = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button/span[text()='Next']")));
        next.click();
        Thread.sleep(3000);
    }
